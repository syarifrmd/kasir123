...
<head>
    ...
    <title>Konfirmasi Password - Kasir App</title>
    @vite(['resources/css/app.css','resources/js/app.js'])
    <style>
        body { background:#f4f6fb; margin:0; font-family:Inter, ui-sans-serif, system-ui; }
        .wrap { min-height:100vh; display:grid; place-items:center; padding:20px; }
        .card { width:100%; max-width:800px; background:#fff; border-radius:22px; overflow:hidden; box-shadow:0 24px 60px rgba(43,53,116,.15); display:grid; grid-template-columns:1fr 1fr; }
        ...
        h1 { font-size:32px; font-weight:800; margin:0 0 18px; letter-spacing:-.02em; color:#0f172a; }
        ...
        @media (max-width:880px){ .card{ grid-template-columns:1fr; } .right{ display:none; } .left{ padding:46px 28px; } }
    </style>
</head>
<body>
    <div class="wrap">
        <div class="card">
            <div class="left">
                ...
                <p class="desc">Area ini aman. Masukkan password Anda kembali untuk melanjutkan.</p>
                @if ($errors->any())
                    <div class="error">
            ...
            <div class="right"><div class="art"><img src="{{ asset('images/login.png') }}" alt="Confirm Illustration"></div></div>
        </div>
    </div>
</body>
</html>
