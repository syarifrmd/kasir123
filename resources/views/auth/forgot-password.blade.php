...
<head>
    ...
    <title>Lupa Password - Kasir App</title>
    ...
    <style>
        ...
        p.desc { color:#6b7280; margin:0 0 32px; font-size:14px; }
        label { display:block; font-size:13px; font-weight:600; margin-bottom:8px; color:#111827; }
        input[type=email] { width:100%; padding:14px 16px; border:1px solid #e5e7eb; border-radius:10px; font-size:14px; outline:none; transition:.2s; }
        input[type=email]:focus { border-color:#7c3aed; box-shadow:0 0 0 4px rgba(124,58,237,.12); }
    ...
    <div class="wrap">
        <div class="card">
            <div class="left">
                ...
                <h1>Lupa Password</h1>
                <p class="desc">Masukkan email Anda dan kami kirimkan link untuk reset password.</p>
                @if (session('status'))
            ...
            <div class="right"><div class="art"><img src="{{ asset('images/login.png') }}" alt="Forgot Illustration"></div></div>
        </div>
    </div>
</body>
</html>
